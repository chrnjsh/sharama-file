...
public class Tc_002FirstNameTextBox {
	
//	@DataProvider(name = "TC_002")
//	public String[][] data() {
//		return ReadData.readDataExcel("testData",21);
//	}
	...
	public void launchBrowser(@Optional("chrome") String bname) {
		String[][] data=ReadData.readDataExcel("testData",21);
		...
		Assert.assertEquals(rp.getFirstNameTextBox().getAttribute("value"),firstName,"data is not provided properly");
