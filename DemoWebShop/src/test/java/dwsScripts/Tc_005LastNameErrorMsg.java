...
public class Tc_005LastNameErrorMsg {
	...
	public void launchBrowser(@Optional("chrome") String bname) {
		...
		rp.getLastNameErrorMsg().click();
		Assert.assertEquals(rp.getLastNameErrorMsg().isDisplayed(),true);
		Reporter.log("click action on text box",true);
		rp.getLastNameErrorMsg().sendKeys("charan");
